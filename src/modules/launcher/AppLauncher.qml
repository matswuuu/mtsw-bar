...
PanelWindow {
    ...
    function launchSelected() {
        ...
        if (!app) return
        launcher.command = ["bash", "-c", app.exec]
    ...
    mask: Region {
        item: isOpen ? overlay : emptyRegion
    }

    Item {
        id: emptyRegion; width: 0; height: 0
    }
    ...
    Process {
        id: appScanner
        command: ["bash", "/home/matswuuu/mtsw-bar/src/modules/launcher/list-apps.sh"]
        running: false
